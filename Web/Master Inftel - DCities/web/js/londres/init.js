...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'max': { range: '*', href: 'css/londres/style.css', containers: 1440, viewport: { scalable: false }, grid: { gutters: 40 } },
			'wide': { range: '-1920', href: 'css/londres/style-wide.css', containers: 1360 },
			'normal': { range: '-1680', href: 'css/londres/style-normal.css', containers: 1200 },
			'narrow': { range: '-1280', href: 'css/londres/style-narrow.css', containers: 960 },
			'narrower': { range: '-1000', href: 'css/londres/style-narrower.css', containers: '95%' },
			'mobile': { range: '-736', href: 'css/londres/style-mobile.css', grid: { gutters: 20 } },
