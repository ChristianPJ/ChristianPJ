...
import es.uma.inftel.blogREST.domain.Imagen;
 ...
 */
@Stateless
@Path("es.uma.inftel.blogrest.domain.imagen")
public class ImagenFacadeREST extends AbstractFacade<Imagen> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") BigDecimal id, Imagen entity) {
        super.edit(entity);
    }
    ...
    public Imagen find(@PathParam("id") BigDecimal id) {
