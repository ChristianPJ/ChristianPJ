...
import es.uma.inftel.blogREST.domain.Comentario;
 ...
 */
@Stateless
@Path("es.uma.inftel.blogrest.domain.comentario")
public class ComentarioFacadeREST extends AbstractFacade<Comentario> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") BigDecimal id, Comentario entity) {
        super.edit(entity);
    }
    ...
    public Comentario find(@PathParam("id") BigDecimal id) {
