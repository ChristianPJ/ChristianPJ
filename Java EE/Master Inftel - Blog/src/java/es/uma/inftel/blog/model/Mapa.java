...
public class Mapa implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "generadorSeqMapa", sequenceName = "MAPA_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "generadorSeqMapa")
    ...
    public String toString() {
        return "es.uma.inftel.blog.model.Mapa[ id=" + id + " ]";
    }
