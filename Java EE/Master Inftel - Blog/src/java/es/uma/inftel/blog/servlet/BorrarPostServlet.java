 ...
 * @author inftel07
 */
@WebServlet(name = "BorrarPostServlet", urlPatterns = {"/BorrarPostServlet"})
public class BorrarPostServlet extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String varPost = request.getParameter("post");
        Long idPost = Long.valueOf(varPost);
