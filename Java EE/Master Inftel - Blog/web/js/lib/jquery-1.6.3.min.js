...
(function(a,b){
    ...
    function L(a){
        ...
        if(!(a.liveFired===this||!r||!r.live||a.target.disabled||a.button&&a.type==="click")){
            ...
            for(i=0;i<s.length;i++)g=s[i],g.origType.replace(w,"")===a.type?q.push(g.selector):s.splice(i--,1);e=f(a.target).closest(q,a.currentTarget);
    ...
    function k(a,c,d){if(d===b&&a.nodeType===1){
    ...
    var c=a.document,d=a.navigator,e=a.location,f=function(){
        ...
        e.fn=e.prototype={
            ...
            pushStack:function(a,b,c){
                ...
                e.isArray(a)?F.apply(d,a):e.merge(d,a),d.prevObject=this,d.context=this.context,b==="find"?d.selector=this.selector+(this.selector?" ":"")+c:b&&(d.selector=this.selector+"."+b+"("+c+")");return d
            },
            each:function(a,b){
                ...
                e.fn.init.prototype=e.fn,e.extend=e.fn.extend=function(){
                    ...
                    return i
                        ...
                        e.extend({
                            ...
                            ready:function(a){if(a===!0&&!--e.readyWait||a!==!0&&!e.isReady){
