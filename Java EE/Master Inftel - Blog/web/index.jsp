...
<html lang="${language}">
    ...
    <body>
        <div id="wrapper">
            <div id="header-wrapper">
                <div id="header">
                    ...
                    <div id="menu">
                        <ul>
                            <li><a class="button button-nav current-page-item" href="#"><fmt:message key="btn-inicio" /></a></li>
                            <c:choose>
            ...
            <div id="page">
                <div id="content">
                    <c:forEach var="postSummary" items="${indexView.currentPagePostSummaries}">
                        <div class="post">
                    ...
                    <div class="pagination-container">
                        <div class="pagination">
                            ...
                            <input type="text" readonly="readonly" data-current-page="${indexView.currentPage}" data-max-page="${indexView.lastPage}" />
                    ...
                    <div id="sidebar-content">
                        <ul>
                            ...
                            <li>
                                ...
                                <ul id="archivo">
                                    <c:forEach var="yearEntry" items="${indexView.postsArchive}">
        ...
        <script src="js/pagination-index.js" type="text/javascript"></script>
