Public Class Proyectos
        ...
        If TextBox1.Text.Length = 3 Then
            If IsNumeric(TextBox1.Text) Then
                If Not (TextBox2.Text = String.Empty) And (TextBox2.Text.Length < 255) Then
                    comm.CommandText = "select * from TablaProyecto where CodigoProyecto= " & "'" & TextBox1.Text & "'"
                    ...
                    If myReader.Tables(0).Rows.Count = 0 Then
                        ...
                        If MsgBox("¿ Insertar: " + TextBox1.Text + " - " + TextBox2.Text + "?", vbOKCancel) = vbOK Then
                            comm.CommandText = "insert into TablaProyecto values ('" + TextBox1.Text + "','" + TextBox2.Text + "')"
                            comm.ExecuteNonQuery()
                            cnx.Close()

                            main()
                            comm.CommandText = "insert into TablaProyectoCambio values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + usuario + "','" + Fecha + "','Insertado')"
                            comm.ExecuteNonQuery()
                            cnx.Close()
            ...
            If IsNumeric(TextBox1.Text) Then
                If Not (TextBox2.Text = String.Empty) Then
                    ...
                    If myReader.Tables(0).Rows.Count > 0 Then
                        cnx.Close()
                        main()
                        des = myReader.Tables(0).Rows(0)("DescripcionProyecto")
                        If MsgBox("¿ Modificar Codigo: " + TextBox1.Text + " " + Chr(13) + "  " + des + " por " + TextBox2.Text + "?", vbOKCancel) = vbOK Then
                            comm.CommandText = "update TablaProyecto set DescripcionProyecto=" & "'" & TextBox2.Text & "' where CodigoProyecto=" & "'" & TextBox1.Text & "'"
                            comm.ExecuteNonQuery()
                            cnx.Close()
                            main()
                            comm.CommandText = "insert into TablaProyectoCambio values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + usuario + "','" + Fecha + "','Modificado')"
                            comm.ExecuteNonQuery()
                            Listar_Click(Nothing, Nothing)
                        End If
                    Else
        ...
        If TextBox1.Text.Length = 3 Then
            If IsNumeric(TextBox1.Text) Then
                ...
                If myReader.Tables(0).Rows.Count > 0 Then
                    ...
                    comm.CommandText = "select * from TablaFacturas where Proyecto= " & "'" & TextBox1.Text & "'"
                    ...
                    Else
                        ...
                        If MsgBox("¿ Borrar: " + TextBox1.Text + "-" + des + "?", vbOKCancel) = vbOK Then
                            comm.CommandText = "delete from TablaProyecto where CodigoProyecto= " + TextBox1.Text + ""
                            comm.ExecuteNonQuery()
                            cnx.Close()
                            main()
                            comm.CommandText = "insert into TablaProyectoCambio values ('" + TextBox1.Text + "','','" + usuario + "','" + Fecha + "','Borrado')"
                            comm.ExecuteNonQuery()
    ...
    Private Sub Detallar_Click(sender As System.Object, e As System.EventArgs) Handles Detallar.Click
        ...
        If TextBox1.Text.Length = 3 Then
            If IsNumeric(TextBox1.Text) Then
                comm.CommandText = "select * from TablaProyectoCambio where CodigoProyecto= " & "'" & TextBox1.Text & "' order by FechaProyecto asc "
    ...
    Private Sub Listar_Click(sender As System.Object, e As System.EventArgs) Handles Listar.Click
        cnx.Close()
        main()
        comm.CommandText = "select CodigoProyecto Código, DescripcionProyecto Descripción from TablaProyecto order by CodigoProyecto"
    ...
    Private Sub Proyectos_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        cnx.Close()
        Label8.Text = "Usuario : " + usuario + ""
    ...
    Private Header As String = "Proyectos"
