...
Public Class Departamentos
    ...
    Private Sub Agregar_Click(sender As System.Object, e As System.EventArgs) Handles Agregar.Click
        ...
        If TextBox1.Text.Length = 3 Then
            ...
            If iLen > 0 Then
                For iCtr = 1 To iLen
                    Caracter = Mid(Temp, iCtr, 1)
                    If Not Caracter Like "[A-Z]" Then
                        Valido = False
                    End If
                ...
                If Valido Then
                    If Not (TextBox2.Text = String.Empty) And (TextBox2.Text.Length < 255) Then
                        comm.CommandText = "select * from TablaDepartamento where CodigoDepartamento= " & "'" & TextBox1.Text & "'"
                        ...
                        If myReader.Tables(0).Rows.Count = 0 Then
                            ...
                            main()
                            If MsgBox("¿ Insertar: " + TextBox1.Text + " - " + TextBox2.Text + "?", vbOKCancel) = vbOK Then
                                comm.CommandText = "insert into TablaDepartamento values ('" + TextBox1.Text + "','" + TextBox2.Text + "')"
                                comm.ExecuteNonQuery()
                                cnx.Close()

                                main()
                                comm.CommandText = "insert into TablaDepartamentoCambio values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + usuario + "','" + Fecha + "','Insertado')"
                                comm.ExecuteNonQuery()
                                cnx.Close()
                    ...
                    End If
                Else
                    MessageBox.Show("Código no correcto.")
                End If
            End If
        Else
                    ...
                    If Not (TextBox2.Text = String.Empty) Then
                        ...
                        If myReader.Tables(0).Rows.Count > 0 Then
                            ...
                            If MsgBox("¿ Modificar Codigo: " + TextBox1.Text + " " + Chr(13) + "  " + des + " por " + TextBox2.Text + "?", vbOKCancel) = vbOK Then
                                comm.CommandText = "update TablaDepartamento set DescripcionDepartamento=" & "'" & TextBox2.Text & "' where CodigoDepartamento=" & "'" & TextBox1.Text & "'"
                                comm.ExecuteNonQuery()
                                cnx.Close()
                                main()
                                comm.CommandText = "insert into TablaDepartamentoCambio values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + usuario + "','" + Fecha + "','Modificado')"
                                comm.ExecuteNonQuery()
                                Listar_Click(Nothing, Nothing)
                            End If
                        Else
            ...
            If iLen > 0 Then
                ...
                If Valido Then
                    ...
                    If myReader.Tables(0).Rows.Count > 0 Then
                        ...
                        comm.CommandText = "select * from TablaFacturas where Departamento= " & "'" & TextBox1.Text & "'"
                        ...
                        Else
                            ...
                            If MsgBox("¿ Borrar: " + TextBox1.Text + "-" + des + "?", vbOKCancel) = vbOK Then
                                comm.CommandText = "delete from TablaDepartamento where CodigoDepartamento= " & "'" & TextBox1.Text & "'"
                                comm.ExecuteNonQuery()
                                cnx.Close()
                                main()
                                comm.CommandText = "insert into TablaDepartamentoCambio values ('" + TextBox1.Text + "','','" + usuario + "','" + Fecha + "','Borrado')"
                                comm.ExecuteNonQuery()
    ...
    Private Sub Detallar_Click(sender As System.Object, e As System.EventArgs) Handles Detallar.Click
        ...
        If TextBox1.Text.Length = 3 Then
            ...
            If iLen > 0 Then
                ...
                If Valido Then
                    comm.CommandText = "select * from TablaDepartamentoCambio where CodigoDepartamento= " & "'" & TextBox1.Text & "' order by FechaDepartamento asc "
    ...
    Private Sub Listar_Click(sender As System.Object, e As System.EventArgs) Handles Listar.Click
        ...
        cnx.Close()
        main()
        comm.CommandText = "select CodigoDepartamento Código, DescripcionDepartamento Descripción from TablaDepartamento order by CodigoDepartamento"
    ...
    Private Header As String = "Departamentos"
