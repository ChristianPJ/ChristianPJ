Public Class Subcuentas
    ...
    Private Sub Agregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Agregar.Click
        ...
        If TextBox1.Text.Length = 8 Then
            If IsNumeric(TextBox1.Text) Then
                ...
                Dim aux2 As String
                Dim copia As String
                copia = TextBox1.Text.Substring(0, 4)
                aux = copia.Substring(0, 3)
                aux2 = copia.Substring(3, 1)
                While (copia.Length > 1) And (aux2 = 0)
                    copia = aux
                    aux = copia.Substring(0, copia.Length - 1)
                    aux2 = copia.Substring(copia.Length - 1, 1)
                End While
                comm.CommandText = "select * from TablaCuenta where CodigoCuenta= " & "'" & copia & "'"
                ...
                If Not (myReader.Tables(0).Rows.Count = 0) Then
                    ...
                    If Not (TextBox2.Text = String.Empty) Then
                        ...
                        If myReader2.Tables(0).Rows.Count = 0 Then
                            ...
                            If MsgBox("¿ Insertar: " + TextBox1.Text + " - " + TextBox2.Text + "?", vbOKCancel, "Confirmación") = vbOK Then
                                comm.CommandText = "insert into TablaSubcuenta values ('" + TextBox1.Text + "','" + TextBox2.Text + "')"
                                comm.ExecuteNonQuery()
                                cnx.Close()

                                main()
                                comm.CommandText = "insert into TablaSubcuentaCambio values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + usuario + "','" + Fecha + "','Insertado')"
                                comm.ExecuteNonQuery()
                                cnx.Close()
                    ...
                    End If
                Else
                    MessageBox.Show("Codigo de cuenta no existente.")
                End If
            Else
                MessageBox.Show("Código no numérico.")
            End If
        Else
            MessageBox.Show("Código incorrecto. Debe tener 8 cifras.")
    ...
    Private Sub Listar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Listar.Click
        ...
        main()
        comm.CommandText = "select CodigoSubcuenta Código, DescripcionSubcuenta Descripción from TablaSubcuenta order by CodigoSubcuenta"
        ...
        If TextBox1.Text.Length = 8 Then
            If IsNumeric(TextBox1.Text) Then
                ...
                If myReader.Tables(0).Rows.Count > 0 Then
                    cnx.Close()
                    main()
                    des = myReader.Tables(0).Rows(0)("DescripcionSubcuenta")
                    If MsgBox("¿ Modificar Codigo: " + TextBox1.Text + " " + Chr(13) + "  " + des + " por " + TextBox2.Text + "?", vbOKCancel, "Confirmación") = vbOK Then
                        comm.CommandText = "update TablaSubcuenta set DescripcionSubcuenta=" & "'" & TextBox2.Text & "' where codigoSubcuenta=" & "'" & TextBox1.Text & "'"
                        comm.ExecuteNonQuery()
                        cnx.Close()
                        main()
                        comm.CommandText = "insert into TablaSubcuentaCambio values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + usuario + "','" + Fecha + "','Modificado')"
                        comm.ExecuteNonQuery()
                        Listar_Click(Nothing, Nothing)
                    End If
                Else
        ...
        If TextBox1.Text.Length = 8 Then
            If IsNumeric(TextBox1.Text) Then
                ...
                If myReader.Tables(0).Rows.Count > 0 Then
                    ...
                    comm.CommandText = "select * from TablaFacturas where Subcuenta= " & "'" & TextBox1.Text & "'"
                    ...
                    Else
                        ...
                        If MsgBox("¿ Borrar: " + TextBox1.Text + "-" + des + "?", vbOKCancel, "Confirmación") = vbOK Then
                            comm.CommandText = "delete from TablaSubcuenta where CodigoSubcuenta= " + TextBox1.Text + ""
                            comm.ExecuteNonQuery()
                            cnx.Close()
                            main()
                            comm.CommandText = "insert into TablaSubcuentaCambio values ('" + TextBox1.Text + "','','" + usuario + "','" + Fecha + "','Borrado')"
                            comm.ExecuteNonQuery()
    ...
    Private Sub Detallar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detallar.Click
        ...
        If TextBox1.Text.Length = 8 Then
            If IsNumeric(TextBox1.Text) Then
                comm.CommandText = "select * from TablaSubcuentaCambio where CodigoSubcuenta= " & "'" & TextBox1.Text & "' order by FechaSubcuenta asc"
    ...
    Private Sub Subcuentas_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        cnx.Close()
    ...
    Private Header As String = "Subcuentas"
