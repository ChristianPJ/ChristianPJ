...
Public Class Conceptos
        ...
        If TextBox1.Text.Length = 3 Then
            If IsNumeric(TextBox1.Text) Then
                If Not (TextBox2.Text = String.Empty) And (TextBox2.Text.Length < 255) Then
                    comm.CommandText = "select * from TablaConcepto where CodigoConcepto= " & "'" & TextBox1.Text & "'"
                    ...
                    If myReader.Tables(0).Rows.Count = 0 Then
                        ...
                        If MsgBox("¿ Insertar: " + TextBox1.Text + " - " + TextBox2.Text + "?", vbOKCancel, "Confirmación") = vbOK Then
                            comm.CommandText = "insert into TablaConcepto values ('" + TextBox1.Text + "','" + TextBox2.Text + "')"
                            comm.ExecuteNonQuery()
                            cnx.Close()

                            main()
                            comm.CommandText = "insert into TablaConceptoCambio values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + usuario + "','" + Fecha + "','Insertado')"
                            comm.ExecuteNonQuery()
                            cnx.Close()
            ...
            End If
        Else
            MessageBox.Show("Código incorrecto. Debe tener 3 cifras.")
        ...
        If TextBox1.Text.Length = 3 Then
            If IsNumeric(TextBox1.Text) Then
                ...
                If myReader.Tables(0).Rows.Count > 0 Then
                    ...
                    comm.CommandText = "select * from TablaFacturas where Concepto= " & "'" & TextBox1.Text & "'"
                    ...
                    Else
                        ...
                        cnx.Close()
                        main()
                        des = myReader.Tables(0).Rows(0)("DescripcionDepartamento")
                        If MsgBox("¿ Borrar: " + TextBox1.Text + "-" + des + "?", vbOKCancel) = vbOK Then
                            comm.CommandText = "delete from TablaConcepto where CodigoConcepto= " + TextBox1.Text + ""
                            comm.ExecuteNonQuery()
                            cnx.Close()
                            main()
                            comm.CommandText = "insert into TablaConceptoCambio values ('" + TextBox1.Text + "','','" + usuario + "','" + Fecha + "','Borrado')"
                            comm.ExecuteNonQuery()
    ...
    Private Sub Detallar_Click(sender As System.Object, e As System.EventArgs) Handles Detallar.Click
        ...
        If TextBox1.Text.Length = 3 Then
            If IsNumeric(TextBox1.Text) Then
                comm.CommandText = "select * from TablaConceptoCambio where CodigoConcepto= " & "'" & TextBox1.Text & "' order by FechaConcepto asc "
    ...
    Private Sub Listar_Click(sender As System.Object, e As System.EventArgs) Handles Listar.Click
        cnx.Close()
        main()
        comm.CommandText = "select CodigoConcepto Código, DescripcionConcepto Descripción from TablaConcepto order by CodigoConcepto"
    ...
    Private Sub Cuentas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Label4.Text = "Usuario : " + usuario + ""
        If priv = "Administrador" Then
            ...
            If IsNumeric(TextBox1.Text) Then
                If Not (TextBox2.Text = String.Empty) And (TextBox2.Text.Length < 255) Then
                    ...
                    If myReader.Tables(0).Rows.Count > 0 Then
                        cnx.Close()
                        main()
                        des = myReader.Tables(0).Rows(0)("DescripcionConcepto")
                        If MsgBox("¿ Modificar Codigo: " + TextBox1.Text + " " + Chr(13) + "  " + des + " por " + TextBox2.Text + "?", vbOKCancel) = vbOK Then
                            comm.CommandText = "update TablaConcepto set DescripcionConcepto=" & "'" & TextBox2.Text & "' where CodigoConcepto=" & "'" & TextBox1.Text & "'"
                            comm.ExecuteNonQuery()
                            cnx.Close()
                            main()
                            comm.CommandText = "insert into TablaConceptoCambio values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + usuario + "','" + Fecha + "','Modificado')"
                            comm.ExecuteNonQuery()
                            Listar_Click(Nothing, Nothing)
                        End If
                    Else
                    ...
                    End If
                Else
                    MessageBox.Show("Falta Descripción o demasiado larga.")
                End If
            Else
                MessageBox.Show("Código no numérico.")
            End If
    ...
    Private Sub Conceptos_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        cnx.Close()
        Label4.Text = "Usuario : " + usuario + ""
    ...
    Private Header As String = "Conceptos"
